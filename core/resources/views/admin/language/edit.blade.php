                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.language.update', $language->id) }}" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="name" id="name" class="form-control" value="{{ $language->name }}" placeholder="{{ __('Enter Name') }}">
                                    @if($errors->has('name'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="code" id="code" class="form-control" value="{{ $language->code }}" placeholder="{{ __('Enter Code') }}">
                                    @if($errors->has('code'))
