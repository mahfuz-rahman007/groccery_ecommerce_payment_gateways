                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{ route('admin.setting.updatebasicinfo', $basicinfo->language_id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="website_title" id="nawebsite_titleme" class="form-control" value="{{$basicinfo->website_title}}" placeholder="{{ __('Site Title') }}">
                        ...
                        <form class="form-horizontal" action="{{ route('admin.setting.updatecommoninfo') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label  class="col-sm-2 control-label">{{ __('Contact Form Email') }}<span
                                        class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" data-role="tagsinput"  name="contactemail" placeholder="{{ __('Contact Form Email') }}" value="{{ $commonsetting->contactemail }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <img class="w-50 mb-3 img-demo show-img" src="
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 control-label">{{ __('Site Logo') }} <span class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <img class="mb-3 img-demo show-img" src="
                                    @if($commonsetting->website_logo)
                                    {{ asset('assets/front/img/'.$commonsetting->website_logo) }}
                                    @else
                                    {{ asset('assets/admin/img/img-demo.jpg') }}
                                    @endif" alt="">
                                    <div class="custom-file">
                                        <label class="custom-file-label" for="website_logo">Choose New Image</label>
                                        <input type="file" class="custom-file-input up-img" name="website_logo" id="website_logo">
                                    </div>
