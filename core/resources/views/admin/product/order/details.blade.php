                            ...
                            <table class="table  table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <strong>Cost :</strong>
                                        {{ $order->currency_sign }}{{ $shipping_charge_info['cost'] }} <br>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($cart as $key => $item)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                <img class="w-80" src="{{ asset('assets/front/img/' . $item['photo']) }}"
                                                    alt="product">
                                            </td>
                                            <td>{{ Helper::convertUtf8($item['name']) }}</td>
                                            <td>
                                            ...
                                            <td>{{ $order->currency_sign }}
                                                {{ round($item['price'] * $item['qty'] * $order->currency_value, 2) }}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
